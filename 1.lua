...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('One Hub BF Premium') then
        makefolder('One Hub BF Premium')
    end
    if not _G.Dis and not isfile('One Hub BF Premium/'..Name..'.json') then
        writefile('One Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('One Hub BF Premium') and isfile('One Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('One Hub BF Premium/'..Name..'.json'))
